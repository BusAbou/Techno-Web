 ...
 */
  ...
  /* if (!isset($_GET['seconds'])) {
      $seconds = 0;  // Si seconds n'est pas spécifié, on le met à 0
   } elseif ($_GET['seconds'] === '') {
      $seconds = 0;  // Si seconds est une chaîne vide, on le met à 0
   } elseif (!ctype_digit($_GET['seconds'])) {
