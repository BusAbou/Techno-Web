 ...
 */
 ...
 <style>
    #base{
      fill : <?php echo $bgColor; ?>; /* couleur du fond : bg */
    }
    #hourMarker, #minMarker, #centerMarker{
      stroke : grey; /*couleur des marqueurs : markers */
      fill : grey;   /*couleur des marqueurs : markers */
    }
    .hand{
      stroke : <?php echo $hands; ?>;  /* couleur des aiguilles h et mn : hands */
    }
    .hand.seconds{
